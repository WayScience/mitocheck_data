...
positive_control_data_final_dir = pathlib.Path(
    f"{final_data_dir}/positive_control_data/"
)
...
positive_control_locations_path = pathlib.Path(
    f"{locations_dir}/positive_control_locations.tsv"
)
positive_control_data = pd.read_csv(
    positive_control_locations_path, sep="\t", index_col=0
)
